				...
				<div className="container">
					<h4 className="flex items-center gap-3 text-2xl font-bold leading-[28px] mb-8">
						...
						<span className="w-0 flex-grow">
							About Mykonos Airport (JMK)
						</span>
					</h4>
					<div className="text-sm">
						<strong>Call Centre:</strong> +30 (22890) 79000
						<div>
							Online form for Inquiries and Complaints. Online form
							for Lost Property.
						</div>
						<br />
						<div>
						...
						<div className="underline">
							Mykonos International Airport (JMK) <br /> Mykonos, 847
							00, Greece
						</div>
						<br />
						<div>
							<strong>Airport Latitude and Longitude:</strong>
						</div>
						...
						/>
						<div>
							Mykonos Airport (JMK) is the primary arrival point for
							travelers visiting this iconic Cycladic island. Located
							just 4 kilometers from Mykonos Town, the airport provides
							convenient access to the island’s renowned beaches, ports,
							and luxury accommodations. Serving both domestic and
							international flights, Mykonos Airport operates year-round,
							with a surge in activity during the summer months to
							accommodate the influx of visitors. Its manageable size and
							straightforward layout make it easy for passengers to
							navigate, offering a smooth start or end to their journey.
							<br />
							<br />
							The airport features essential facilities such as cafes,
							duty-free shops, and car rental services, ensuring a
							comfortable travel experience. For onward transportation,
							taxis and private transfers are the most popular options,
							providing quick and reliable connections to your
							destination. Public buses also operate to select locations,
							though schedules can vary. To make your arrival
							stress-free, booking an Aegean Taxi transfer in advance
							guarantees a seamless and comfortable ride, allowing you to
							focus on enjoying your time in Mykonos.
						</div>
					</div>
					<div className="flex pt-6">
						<Link href={""} className="block">
							<button
								...
								type="button"
							>
								<span>Go to Mykonos Airport Transfers</span>
								{arrowRight}
							</button>
						</Link>
					</div>
...
const menudata = [
	{
		id: "1",
		name: "About Mykonos Airport",
	},
	{
		id: "2",
		name: "Getting to  <br /> and from",
	},
	{
		id: "3",
		name: "Live <br /> Arrivals",
	},
	{
		id: "11",
		name: "About Mykonos Airport",
...
export default AboutMykonosAirPort;
