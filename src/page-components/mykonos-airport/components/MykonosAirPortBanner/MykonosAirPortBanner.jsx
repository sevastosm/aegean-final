			...
			<div className="relative">
				<section className="pt-[80px] relative pb-[26px]">
					<div className="container max-sm:px-6 relative">
						<div>
							<h1 className="text-[36px] leading-[42px] font-bold text-center text-shadow">
								Mykonos Airport (JMK)
							</h1>
							<div className="h-[151px] relative mb-12">
								<Image
									className="absolute w-[100vw] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[unset]"
									width={400}
									height={400}
									src={banner}
									alt=""
							...
							<h5 className="my-3 font-semibold text-xl text-center -mx-3">
								Useful Mykonos airport information. Book a ride to and
								from Mykonos airport, for now or later
							</h5>
							<div className="relative">
								<div className="p-[1px] rounded-[20px]">
									<div className="mb-[10px] relative">
										...
										<input
											...
											className="w-full border border-[#766A6A] bg-[#F3F3F3] rounded-lg font-medium placeholder:text-[#818181] h-10 outline-none shadow-none pl-[57px] pr-5"
										/>
									...
									<div className="flex justify-between pb-4 gap-[6px]">
										...
										>
											<Image
												...
												alt=""
											/>
											<div className="text-primary">Call</div>
										</Link>
										<Link href="" className="block flex-grow">
											<button
												className="bg-black font-bold text-xl text-white h-[50px] rounded-lg w-full"
...
export default MykonosAirPortBanner;
