			...
			<div className="relative">
				...
				<section className="pt-[80px] relative pb-[26px]">
					<div className="container max-sm:px-6 relative">
						<div>
							<h1 className="text-[36px] leading-[42px] font-bold mb-[14px] text-center">
							...
							<h5 className="my-3 font-semibold text-xl mx-auto">
								Book a mykonos airport taxi ride to and from the
								airport. Book now or schedule for later
							</h5>
							<div className="relative">
