	...
	return (
		<section className="book-ride-section py-[60px] overflow-hidden">
			<div className="container">
				<div className="mb-7">
					<h2 className="text-[30px] leading-[36px] font-bold mb-5">
				...
				<div className="mt-10 mb-6">
					<button
						type="button"
						className="btn flex items-center gap-2 justify-center bg-[#004080] text-white h-9 rounded-full text-sm px-10 w-full"
					>
						Show More
					</button>
				</div>
