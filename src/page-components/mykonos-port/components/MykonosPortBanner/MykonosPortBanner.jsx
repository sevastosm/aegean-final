				...
				<section className="pt-[80px] relative pb-[26px]">
					<div className="container max-sm:px-6 relative">
						<div>
							...
							<Image width={400} height={400} src={banner} alt="" />
							<h5 className="my-3 font-semibold text-xl mx-auto">
								Useful Mykonos port information. Book a ride to and from
								Mykonos port, for now or later
							</h5>
							<div className="relative">
...
export default MykonosPortBanner;
